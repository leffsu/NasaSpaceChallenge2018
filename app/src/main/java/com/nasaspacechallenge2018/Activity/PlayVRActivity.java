...
public class PlayVRActivity extends AppCompatActivity {
    private String TAG = "PlayVRActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_vr_layout);
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    PlayVRActivity.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
